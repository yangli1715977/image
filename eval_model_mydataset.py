...
# experiment
parser.add_argument('--date', type=str, default='0820')
...
parser.add_argument('--testset-path', type=str, default='./dataset/mydatatest.tfr')
...
parser.add_argument('--checkpoint-path', type=str, default='./model/-235500')
parser.add_argument('--resume-step', type=int, default=0)


args = parser.parse_args()

testset_length=len(os.listdir('mydataset'))

if args.batch_size>=testset_length:
    args.batch_size=1
# prepare path
...
with tf.Session(config=config) as sess:
    with tf.device('/cpu:0'):
        ...
        for _ in range(math.floor(testset_length / args.batch_size)):
